...
import ProtectedRoute from "../middleware/RouteVerify"
...
const CreateTeam = lazy(() => import("../pages/admin/CreateNewTeam"));
    ...
    <Suspense fallback={<p>Carregando página...</p>}>
      <Routes>
        ...
        <Route element={<RoutePrivate />}>
          ...
          <Route path="/AdminManeger/CreateTeam" element={<CreateTeam />}/>
        </Route>
      </Routes>
    </Suspense>
  );
